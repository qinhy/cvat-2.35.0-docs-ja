...
1. オブジェクトが数フレームで見えなくなり、その後再び現れる場合は、
   ...
   - `補間（Interpolation）`モードでの最終的なアノテーション済みフレームシーケンスは
     ...
     詳細は{{< ilink "/docs/manual/advanced/track-mode-advanced" "トラックモード（応用）" >}}のセクションをご覧ください。---
title: '品質管理'
linkTitle: '品質管理'
weight: 21
...
| **データセットとしてエクスポート**        | データセットを{{< ilink "/docs/manual/advanced/formats" "対応フォーマット" >}}のいずれかでダウンロードします。                                                                                                                                                                                                                                                                                                                                                                                            |
...
| **ブロック**<br><br>![](/images/image226.jpg)          | {{< ilink "/docs/manual/advanced/ai-tools#opencv-intelligent-scissors" "OpenCVインテリジェントシザーズ" >}}でポリゴン描画中に自動線生成を一時停止します。また、{{< ilink "/docs/manual/advanced/ai-tools" "AIツール" >}}でオブジェクト作成時のサーバーリクエストを遅延させる際にも使用します。  |
...
---
title: 'ポリラインによるアノテーション'
linkTitle: 'ポリラインによるアノテーション'
weight: 9
description: 'ポリラインを使ったタスクのアノテーションガイド。'
---
...
title: 'データセットのインポートおよびアノテーションのアップロード'
linkTitle: 'データセットのインポートおよびアノテーションのアップロード'
weight: 19
description: 'このセクションでは、プロジェクト、タスク、ジョブのデータセット（アノテーション、画像、メタデータを含む）のダウンロードおよびアップロード方法について説明します。'
---
...
1. データセットのエクスポート形式を選択します。エクスポートとインポートは以下の形式で利用できます:
   - 標準CVAT形式:
     ...
     - {{< ilink "/docs/manual/advanced/xml_format#annotation" "CVAT for images" >}}
       ...
       <br>
   - また、
     {{< ilink "/docs/manual/advanced/formats" "CVATでサポートされているアノテーション形式の一覧" >}}
     の形式も利用できます。
...
1. データセットのエクスポート先ストレージを`ローカル`または`クラウドストレージ`から選択できます。
   ...
   {{< ilink "/docs/manual/basics/attach-cloud-storage" "クラウドストレージの接続" >}}について詳しくはこちらをご覧ください。
...
linkTitle: "上級"
weight: 2
description: 'このセクションにはCVATユーザー向けの上級ドキュメントが含まれています'
------
title: '手動描画'
linkTitle: '手動描画'
weight: 1
...
title: 'ポリゴンによるアノテーション'
linkTitle: 'ポリゴンによるアノテーション'
weight: 8
description: 'ポリゴンの作成と編集ガイド。'
------
title: 'LFW'
linkTitle: 'LFW'
weight: 17
...
weight: 1
description: 'CVAT for image形式でのデータのエクスポートおよびインポート方法'
---
...
- {{< ilink "/docs/manual/advanced/xml_format" "フォーマット仕様" >}}
...
（{{< ilink "/docs/manual/basics/track-mode-basics" "基本" >}}や
{{< ilink "/docs/manual/advanced/track-mode-advanced" "応用" >}}、
{{< ilink "/docs/manual/advanced/annotation-with-polygons/track-mode-with-polygons" "ポリゴンのトラックモード" >}}を参照）。---
